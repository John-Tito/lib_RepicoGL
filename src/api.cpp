...
/**
 * @brief glPushMatrix — push the current matrix stack
*/
...
/**
 * @brief glPopMatrix — pop the current matrix stack
*/
...
/**
 * @brief glRotatef — multiply the current matrix by a rotation matrix
...
/**
 * @brief glTranslate — multiply the current matrix by a translation matrix
...
/**
 * @brief glScale — multiply the current matrix by a general scaling matrix
...
/**
 * @brief glViewport — set the viewport
 * @param x,y Specify the lower left corner of the viewport rectangle, in pixels. The initial value is (0,0).
 * @param width,height Specify the width and height of the viewport. When a GL context is first attached to a window, width and height are set to the dimensions of that window. description
*/
...
/**
 * @brief glBindTexture — bind a named texture to a texturing target
...
/* Special Functions */
/**
 * @brief glCallList — execute a display list
