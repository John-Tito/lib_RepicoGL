...
extern "C"
{
	...
	/**
	 * @brief glBegin — delimit the vertices of a primitive or a group of like primitives
	 * @param mode Specifies the primitive or primitives that will be created from vertices presented between glBegin and the subsequent glEnd.
	 * Ten symbolic constants are accepted: GL_POINTS, GL_LINES, GL_LINE_STRIP, GL_LINE_LOOP, GL_TRIANGLES, GL_TRIANGLE_STRIP, GL_TRIANGLE_FAN,
	 * GL_QUADS, GL_QUAD_STRIP, and GL_POLYGON. description
	*/
...
#define PROTO_GL4(name)                                        \
	...
	/* clear */
	/**
	 * @brief glClear — clear buffers to preset values
	 * @param mask Specifies the integer name of the display list to be executed.
	*/
